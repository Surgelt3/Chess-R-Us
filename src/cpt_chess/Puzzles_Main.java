...
public class Puzzles_Main{
    ...
    public static String winner_loser_text;
    public cpt_chess.Chess_Puzzles_Panel main_puzzle_panel;
    public static JPanel Main_Puzzle_Panel;
    
    /*
    pre: none
    post: removeAll from main_framr and add Main_Puzzle_Panel
    */
    public Puzzles_Main() throws IOException, InterruptedException{
        
        main_frame.getContentPane().removeAll();
        Main_Puzzle_Panel = new cpt_chess.Chess_Puzzles_Panel();
        
        
        main_frame.add(Main_Puzzle_Panel);
